DELETE FROM driver_dashboard;

INSERT INTO driver_dashboard (id, payload) VALUES (
  'primary',
  json('{
    "driver": {
      "id": "driver-784",
    ...
    "route": {
      "status": "En Route",
      "statusTone": "active",
      "mapImage": "https://images.unsplash.com/photo-1524678714210-9917a6c619c4?q=80&w=1800&auto=format&fit=crop",
